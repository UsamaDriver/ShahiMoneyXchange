  ...
  ?>
    <div class="table-widget">
      <span class="caption-container">
        ...
        <?php
          $dbobj = new connectDB();
          $result= $dbobj->getAllBookingRequest();
        ?>
      ...
      <div class="table-wrapper">
        ...
        while ($rec= mysqli_fetch_row($result))
        {
            ...
            <td>$rec[6]</td>
            <td>$rec[7]</td>
            <td class='sticky-right'><a href='../operations.php?action=toggleBookingRequest&bookingID=$rec[0]&check=$rec[8]'><button class='btn btn-primary'>Change Status</button></a></td>
